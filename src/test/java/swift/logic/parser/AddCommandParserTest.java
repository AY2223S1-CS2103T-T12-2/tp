...
import static swift.logic.commands.CommandTestUtil.ADDRESS_DESC_AMY;
import static swift.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
import static swift.logic.commands.CommandTestUtil.EMAIL_DESC_AMY;
import static swift.logic.commands.CommandTestUtil.EMAIL_DESC_BOB;
import static swift.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static swift.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static swift.logic.commands.CommandTestUtil.INVALID_NAME_DESC;
import static swift.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
import static swift.logic.commands.CommandTestUtil.INVALID_TAG_DESC;
import static swift.logic.commands.CommandTestUtil.NAME_DESC_AMY;
import static swift.logic.commands.CommandTestUtil.NAME_DESC_BOB;
import static swift.logic.commands.CommandTestUtil.PHONE_DESC_AMY;
import static swift.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
import static swift.logic.commands.CommandTestUtil.PREAMBLE_NON_EMPTY;
import static swift.logic.commands.CommandTestUtil.PREAMBLE_WHITESPACE;
import static swift.logic.commands.CommandTestUtil.TAG_DESC_FRIEND;
import static swift.logic.commands.CommandTestUtil.TAG_DESC_HUSBAND;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(TypicalPersons.BOB).withTags(VALID_TAG_FRIEND).build();
